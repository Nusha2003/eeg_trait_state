...
def make_splits(labels_path, n_subjects=109, seed=42):
    ...
    for target_sub in selected_subs:
        ...
        # ------------------------------------------
        # Between-subject state decoding (CLEAN)
        # ------------------------------------------
...
if __name__ == "__main__":
    ...
    parser.add_argument("--labels", type=str, default="/home1/amadapur/projects/eeg_trait_state_geometry/data/motor_psd_labels_state6.csv")
    parser.add_argument("--out_dir", type=str, default="/home1/amadapur/projects/eeg_trait_state_geometry/splits_6classes")
    args = parser.parse_args()

    os.makedirs(args.out_dir, exist_ok=True)

    for size in [109, 20, 10, 4]:
        iterations = 10 if size in [20, 10, 4] else 1
